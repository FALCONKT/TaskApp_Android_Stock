...
// BroadcastReceiver　関連====================
//BroadcastReceiver Class を継承した TaskAlarmReceiver Class を作成
class TaskAlarmReceiver : BroadcastReceiver() {

    // BroadcastReceiver　関連====================
    // Alermを受け取るようにしている
    //onReceiveMEthodをOverrideして、Logを出力するように
    //Log は　import
    override fun onReceive(context: Context, intent: Intent) {
        Log.d("TaskApp", "onReceive")

        //NotificationManager/Notification 関連＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝
        val notificationManager = context.getSystemService(Context.NOTIFICATION_SERVICE) as NotificationManager

//        Build　NotificationChannel　NotificationManager　import要
        ...
        //   NotificationCompat　BitmapFactory　Notification　import要
        // 通知の設定を行う
        ...
        // PendingIntent import要
        // IntentはAlermのときと同じようにIntentを作成し、そのIntentを指定して作成したPendingIntent
